...
@section('content')
    ...
    <div class="md-fab-wrapper">
        ...
        <x-heroicon-s-check-circle class="icon-style-btn-Large icon-success  " id="post-edit-composant" data-url="{{route('USER-LOGGED-POST-EDIT-TRADUCTION-COMPOSANT-ILUSTRATION')}}" />
